            ...
            if(isset($_SESSION['current_user'])) {
                ...
                <div class="centerDiv" id="newSubmission">
                    <form action="redirect.php" method="POST">
                        <label>*Story Title: <br><input class="textBlockWidth" type="text" name="storyTitle"/> </label><br><br>
                        <label>*Story Content: <br>
                            <input class="textBlockWidth textBlockHeight" type="text" name="storyText"/> </label><br><br>
                            <input type="hidden" name="token" value="<?php echo $_SESSION['token'];?>" />
                        <label>Link to Source: <br><input class="textBlockWidth" type="text" name="storyLink"/> </label><br><br>

                        <!-- <div class="center" id="picUploadDiv">
                        ...
                        <br><input type="hidden" name="newStory" value="newStory" />
                        <input type="submit" class="logbutton hover" name="new_submission" value="Submit"/>
                    </form>
                </div>
                <?php
