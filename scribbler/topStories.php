...
<html lang="en">
    <head>
        ...
        <title>Scribbler Top Stories</title>
    ...
    <div class="taskbar" id="taskbar">
            ...
            <div class="taskbarTabs fixed_center center" id="taskbar">
                ...
                <form  action="topStories.php" method=post>
                    <input type="submit" class="taskbarForms pageNames topStories hover selectedPage" name="Top Stores" value="Top Stories">
                    <input type="hidden" name="token" value="<?php echo $_SESSION['token'];?>" />
                </form>
                </div>
                <div class="inner">
        ...
        <br><p class="title">Top Stories</p>
        <div class="center">
